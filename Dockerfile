...
# Run with:
# docker run -p 12201:12201 -p 9200:9200 -p 5601:5601 -it --name elk <repo-user>/elk
...
# filters
ADD ./01-gelf-input.conf /etc/logstash/conf.d/01-gelf-input.conf
